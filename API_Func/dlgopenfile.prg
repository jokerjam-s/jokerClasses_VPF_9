...
*! Copyright by Anjel 
*!
*! Запрос имени файла "Открыть файл"
...
*! 	 1 - отметка только чтение
*!	   16 - показать кнопку 'Справка'
*!	  256 - разрешить возврат несуществующего пути (создание)
*!   512 - диалог в старом стиле
*!  4096 - файл должен существовать
*!	 8192 - запрос на создание если не существует
*!
*!	tcFilter - строка отбираемых фильтров
*!	tcWTitle - заголовок окна
**************************************************************************
lparameters tnFlag, tcFilter, tcWTitle
