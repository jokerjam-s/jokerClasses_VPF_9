...
Define Class ctlStructure As Exception
	...
	Protected Procedure ReadPCString(m.pnAddress)
		*!* pnAddress is a pointer to a memory pointer
		Local lnAddress, lnLength, lcString
		*!* Get address pointer
		lnAddress = This.ReadUInt(m.pnAddress)
		*!* Get length of memory pointer:
		lnLength = apiHeapSize(apiGetProcessHeap(), 0, m.lnAddress)
		*!* Read value of string pointer, then reads string
		If m.lnLength > 0
			lcString = Sys(2600, m.lnAddress, m.lnLength)
			lcString = Left(m.lcString , At(NULCHAR, m.lcString) - 1)
		Else
			lcString = ""
		Endif
		Return m.lcString
	...
	Protected Procedure WritePCString(pnAddress, pcString)
		...
		*!* Get a new handle for the string:
		lnAddress = This.AllocMem(Len(m.pcString))
	...
	Protected Procedure ReadUInt(pnAddress)
		*!* Reads an unsigned integer (4 bytes)
		Local lnUInt
		lnUInt = CToBin(Sys(2600, m.pnAddress, 4), "4rs")
		If m.lnUInt < 0
			lnUInt = m.lnUInt + 0x100000000
		Endif
		Return m.lnUInt
	Endproc
	...
	Protected Procedure ReadUShort(pnAddress)
		Local lnShort
		lnShort = CToBin(Sys(2600, m.pnAddress, 2), "2rs")
		If m.lnShort < 0
			lnShort = m.lnShort + 0x10000
		Endif
		Return m.lnShort
	Endproc
	...
	Protected Procedure ReadBytes(pnAddress)
		*!* Reads an integer (1 bytes)
		Return CToBin(Sys(2600, m.pnAddress, 1), "1rs")
	Endproc

	Protected Procedure WriteBytes(pnAddress, pnInt)
...
Define Class ctlDOC_INFO_1 As ctlStructure
	...
	Procedure pDocName_Assign(lnNewVal)
	...
	Procedure pOutputFile_Assign(lnNewVal)
	...
	Procedure pDatatype_Assign(lnNewVal)
...
Define Class ctlMENUINFO As ctlStructure
	...
	*!* structure fields
	...
	Procedure fMask_Assign(lnNewVal)
	...
	Procedure dwStyle_Assign(lnNewVal)
	...
	Procedure cyMax_Assign(lnNewVal)
	...
	Procedure hbrBack_Assign(lnNewVal)
	...
	Procedure dwContextHelpID_Assign(lnNewVal)
...
Define Class ctlMENUITEMINFO As ctlStructure
	...
	*!* structure fields
	...
	Hidden Procedure cbSize_Assign(lnNewVal)
	...
	Hidden Procedure fMask_Assign(lnNewVal)
		This.WriteUInt(This.Address + 4, m.lnNewVal)
	Endproc
	...
	Hidden Procedure fType_Assign(lnNewVal)
		This.WriteUInt(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Hidden Procedure fState_Assign(lnNewVal)
		This.WriteUInt(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Hidden Procedure wID_Assign(lnNewVal)
	...
	Hidden Procedure hSubMenu_Assign(lnNewVal)
		This.WriteUInt(This.Address + 20, m.lnNewVal)
	Endproc
	...
	Hidden Procedure hbmpChecked_Assign(lnNewVal)
	...
	Hidden Procedure hbmpUnchecked_Assign(lnNewVal)
	...
	Hidden Procedure dwItemData_Assign(lnNewVal)
	...
	Hidden Procedure dwTypeData_Assign(lnNewVal)
...
Define Class ctlRECT As ctlStructure
	...
	*!*  structure fields
	...
	Hidden Procedure Left_Assign(lnNewVal)
	...
	Hidden Procedure Top_Assign(lnNewVal)
	...
	Hidden Procedure Right_Assign(lnNewVal)
	...
	Hidden Procedure Bottom_Assign(lnNewVal)
	...
	Hidden Procedure Height_Assign(lnNewVal)
	...
	Hidden Procedure Width_Assign(lnNewVal)
...
Define Class ctlMONITORINFOEX As ctlStructure
	...
	Procedure szDevice_Assign(lnNewVal)
...
Define Class ctlMEASUREITEMSTRUCT As ctlStructure
	...
	Procedure CtlType_Assign(lnNewVal)
		This.WriteUInt(This.Address, m.lnNewVal)
	Endproc
	...
	Procedure CtlID_Assign(lnNewVal)
		This.WriteUInt(This.Address + 4, m.lnNewVal)
	Endproc
	...
	Procedure itemID_Assign(lnNewVal)
		This.WriteUInt(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Procedure itemWidth_Assign(lnNewVal)
		This.WriteUInt(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Procedure itemHeight_Assign(lnNewVal)
		This.WriteUInt(This.Address + 16, m.lnNewVal)
	Endproc
	...
	Procedure itemData_Assign(lnNewVal)
		This.WriteUInt(This.Address + 20, m.lnNewVal)
	Endproc
...
Define Class ctlDRAWITEMSTRUCT As ctlStructure
	...
	Procedure itemAction_Assign(lnNewVal)
		This.WriteUInt(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Procedure itemState_Assign(lnNewVal)
		This.WriteUInt(This.Address + 16, m.lnNewVal)
	Endproc
	...
	Procedure hwndItem_Assign(lnNewVal)
		This.WriteUInt(This.Address + 20, m.lnNewVal)
	Endproc
...
Define Class ctlSCROLLINFO As ctlStructure
	...
	Procedure nMin_Assign(lnNewVal)
		This.WriteInt(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Procedure nMax_Assign(lnNewVal)
		This.WriteInt(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Procedure nPage_Assign(lnNewVal)
		This.WriteUInt(This.Address + 16, m.lnNewVal)
	Endproc
	...
	Procedure nPos_Assign(lnNewVal)
	...
	Procedure nTrackPos_Assign(lnNewVal)
...
Define Class ctlNMHDR As ctlStructure
	...
	Procedure hwndFrom_Assign(lnNewVal)
		This.WriteInt(This.Address, m.lnNewVal)
	Endproc
	...
	Procedure idFrom_Assign(lnNewVal)
		This.WriteUInt(This.Address + 4, m.lnNewVal)
	Endproc
	...
	Procedure Code_Assign(lnNewVal)
		This.WriteInt(This.Address + 8, m.lnNewVal)
	Endproc
...
Define Class ctlNMMOUSE As ctlStructure
	...
	Procedure dwItemSpec_Assign(lnNewVal)
		This.WriteUInt(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Procedure dwItemData_Assign(lnNewVal)
		This.WriteUInt(This.Address + 16, m.lnNewVal)
	Endproc
	...
	Procedure dwHitInfo_Assign(lnNewVal)
...
Define Class ctlURL_COMPONENTS As ctlStructure
	...
	Procedure dwStructSize_Assign(lnNewVal)
		This.WriteUInt(This.Address, m.lnNewVal)
	Endproc
	...
	Procedure lpszScheme_Assign(lnNewVal)
		This.WritePCString(This.Address + 4, m.lnNewVal)
	...
	Procedure dwSchemeLength_Assign(lnNewVal)
		This.WriteUInt(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Procedure nScheme_Assign(lnNewVal)
		This.WriteUInt(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Procedure lpszHostName_Assign(lnNewVal)
	...
	Procedure dwHostNameLength_Assign(lnNewVal)
		This.WriteUInt(This.Address + 20, m.lnNewVal)
	Endproc
	...
	Procedure nPort_Assign(lnNewVal)
		This.WriteUInt(This.Address + 24, m.lnNewVal)
	Endproc
	...
	Procedure lpszUserName_Assign(lnNewVal)
	...
	Procedure dwUserNameLength_Assign(lnNewVal)
		This.WriteUInt(This.Address + 32, m.lnNewVal)
	Endproc
	...
	Procedure lpszPassword_Assign(lnNewVal)
		This.WritePCString(This.Address + 36, m.lnNewVal)
	...
	Procedure dwPasswordLength_Assign(lnNewVal)
		This.WriteUInt(This.Address + 40, m.lnNewVal)
	Endproc
	...
	Procedure lpszUrlPath_Assign(lnNewVal)
	...
	Procedure dwUrlPathLength_Assign(lnNewVal)
	...
	Procedure lpszExtraInfo_Assign(lnNewVal)
	...
	Procedure dwExtraInfoLength_Assign(lnNewVal)
...
Define Class ctlWIN32_FIND_DATA As ctlStructure
	...
	Procedure dwFileAttributes_Assign(lnNewVal)
		This.WriteUInt(This.Address, m.lnNewVal)
	Endproc
	...
	Procedure nFileSizeHigh_Assign(lnNewVal)
		This.WriteUInt(This.Address + 28, m.lnNewVal)
	Endproc
	...
	Procedure nFileSizeLow_Assign(lnNewVal)
		This.WriteUInt(This.Address + 32, m.lnNewVal)
	Endproc
	...
	Procedure dwReserved0_Assign(lnNewVal)
		This.WriteUInt(This.Address + 36, m.lnNewVal)
	Endproc
	...
	Procedure dwReserved1_Assign(lnNewVal)
		This.WriteUInt(This.Address + 40, m.lnNewVal)
	Endproc
	...
	Procedure cFileName_Assign(lnNewVal)
	...
	Procedure cAlternateFileName_Assign(lnNewVal)
...
Define Class ctlTOOLINFO As ctlStructure
	...
	*!* Endif
	...
	Procedure lpReserved_Assign(lnNewVal)
...
Define Class ctlLOGFONT As ctlStructure
	...
	Procedure lfHeight_Assign(lnNewVal)
		This.WriteInt(This.Address, m.lnNewVal)
	Endproc
	...
	Procedure lfWidth_Assign(lnNewVal)
		This.WriteInt(This.Address + 4, m.lnNewVal)
	Endproc
	...
	Procedure lfEscapement_Assign(lnNewVal)
		This.WriteInt(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Procedure lfOrientation_Assign(lnNewVal)
		This.WriteInt(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Procedure lfWeight_Assign(lnNewVal)
	...
	Procedure lfItalic_Assign(lnNewVal)
	...
	Procedure lfUnderline_Assign(lnNewVal)
	...
	Procedure lfStrikeOut_Assign(lnNewVal)
	...
	Procedure lfCharSet_Assign(lnNewVal)
	...
	Procedure lfOutPrecision_Assign(lnNewVal)
	...
	Procedure lfClipPrecision_Assign(lnNewVal)
	...
	Procedure lfQuality_Assign(lnNewVal)
	...
	Procedure lfPitchAndFamily_Assign(lnNewVal)
	...
	Procedure lfFaceName_Assign(lnNewVal)
...
Define Class ctlBITMAPINFOHEADER As ctlStructure
	...
	Procedure biSize_Assign(lnNewVal)
		This.WriteUInt(This.Address, m.lnNewVal)
	Endproc
	...
	Procedure biWidth_Assign(lnNewVal)
		This.WriteInt(This.Address + 4, m.lnNewVal)
	Endproc
	...
	Procedure biHeight_Assign(lnNewVal)
		This.WriteInt(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Procedure biPlanes_Assign(lnNewVal)
		This.WriteUShort(This.Address + 12, m.lnNewVal)
	Endproc
	...
	Procedure biBitCount_Assign(lnNewVal)
		This.WriteUShort(This.Address + 14, m.lnNewVal)
	Endproc
	...
	Procedure biCompression_Assign(lnNewVal)
		This.WriteUInt(This.Address + 16, m.lnNewVal)
	Endproc
	...
	Procedure biSizeImage_Assign(lnNewVal)
		This.WriteUInt(This.Address + 20, m.lnNewVal)
	Endproc
	...
	Procedure biXPelsPerMeter_Assign(lnNewVal)
		This.WriteInt(This.Address + 24, m.lnNewVal)
	Endproc
	...
	Procedure biYPelsPerMeter_Assign(lnNewVal)
		This.WriteInt(This.Address + 28, m.lnNewVal)
	Endproc
	...
	Procedure biClrUsed_Assign(lnNewVal)
		This.WriteUInt(This.Address + 32, m.lnNewVal)
	Endproc
	...
	Procedure biClrImportant_Assign(lnNewVal)
		This.WriteUInt(This.Address + 36, m.lnNewVal)
	Endproc
...
Define Class ctlICONDIRENTRY As ctlStructure
	...
	Procedure bHeight_Assign(lnNewVal)
		If m.lnNewVal = 256
			m.lnNewVal = 0
		Endif
		If m.lnNewVal < 0
	...
	Procedure bColorCount_Assign(lnNewVal)
	...
	Procedure bReserved_Assign(lnNewVal)
	...
	Procedure wBitCount_Assign(lnNewVal)
		This.WriteUShort(This.Address + 6, m.lnNewVal)
	Endproc
	...
	Procedure dwBytesInRes_Assign(lnNewVal)
		This.WriteUInt(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Procedure dwImageOffset_Assign(lnNewVal)
		This.WriteUInt(This.Address + 12, m.lnNewVal)
	Endproc
...
Define Class ctlBITMAPFILEHEADER As ctlStructure
	...
	Procedure bfType_Assign(lnNewVal)
		This.WriteUShort(This.Address, m.lnNewVal)
	Endproc
	...
	Procedure bfSize_Assign(lnNewVal)
	...
	Procedure bfReserved1_Assign(lnNewVal)
		This.WriteUShort(This.Address + 6, m.lnNewVal)
	Endproc
	...
	Procedure bfReserved2_Assign(lnNewVal)
		This.WriteUShort(This.Address + 8, m.lnNewVal)
	Endproc
	...
	Procedure bfOffBits_Assign(lnNewVal)
...
Define Class ctlNMCUSTOMDRAW As ctlStructure
	...
	Procedure uItemState_Assign(lnNewVal)
		This.WriteUInt(This.Address + 40, m.lnNewVal)
	Endproc
	...
	Procedure lItemlParam_Assign(lnNewVal)
...
Define Class ctlMCHITTESTINFO As ctlStructure
	...
	Procedure uHit_Assign(lnNewVal)
		This.WriteUInt(This.Address + 12, m.lnNewVal)
	Endproc
